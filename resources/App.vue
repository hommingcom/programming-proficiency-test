  ...
  <div id="app" class="container">
    <div class="container-fluid">
      <form @submit.prevent="filterPropertiesByCriteria()">
        <label>User:</label>
        <select v-model.number="userIdSelected" data-userid>
          <option v-for="user in users" :key="user.id" :value="user.id">
            {{ user.name }}
          </option>
        </select>
        <label>Property Type:</label>
        <select v-model.number="propertyTypeIdSelected" data-typeid>
          <option v-for="type in propertyTypes" :key="type.id" :value="type.id">
            {{ type.name }}
          </option>
        </select>
        <label>Rented From</label>
        <input type="date" v-model="propertyRentedFrom" data-rentedfrom/>
        <label>Rented To</label>
        <input type="date" v-model="propertyRentedTo" data-rentedto/>
